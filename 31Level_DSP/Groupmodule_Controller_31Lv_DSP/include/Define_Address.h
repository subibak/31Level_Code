...
// DAC address(cs4n)
#define DAC_A1_WR          				    ((volatile int *)(0x00380112))			//0001 0001 0010
#define DAC_A2_WR           				((volatile int *)(0x00380124))			//0001 0010 0100
#define DAC_A3_WR           				((volatile int *)(0x00380136))			//0001 0011 0110
#define DAC_A4_WR           				((volatile int *)(0x00380148))			//0001 0100 1000
#define DAC_A5_WR           				((volatile int *)(0x0038015A))			//0001 0101 1010
#define DAC_A6_WR           				((volatile int *)(0x0038016C))			//0001 0110 1100
#define DAC_A7_WR           				((volatile int *)(0x0038017E))			//0001 0111 1110
#define DAC_A8_WR           				((volatile int *)(0x00380180))			//0001 1000 0000
#define DAC_GEN             				((volatile int *)(0x00380192))			//0001 1001 0010
