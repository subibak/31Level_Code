...
interrupt void CANA_1_ISR(void);                      // 9.5 - CANA Interrupt 1
interrupt void CANA_2_ISR(void);                      // 9.6 - CANA Interrupt 2
interrupt void CANB_1_ISR(void);                      // 9.7 - CANB Interrupt 1
interrupt void CANB_2_ISR(void);                      // 9.8 - CANB Interrupt 2
