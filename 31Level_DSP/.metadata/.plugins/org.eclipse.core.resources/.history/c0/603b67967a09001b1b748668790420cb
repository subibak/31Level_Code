...
//----------------------------------------
#ifdef __cplusplus
#pragma DATA_SECTION("IpcTempVolFile");
#else
...
//----------------------------------------
#ifdef __cplusplus
#pragma DATA_SECTION("IpcTempCalFile");
#else
...
//----------------------------------------
#ifdef __cplusplus
#pragma DATA_SECTION("IpcEcatSlaveFile");
#else
...
//----------------------------------------
#ifdef __cplusplus
#pragma DATA_SECTION("IpcECatMasterFile");
#else
