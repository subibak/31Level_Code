...
PAGE 0 :
	...
	RAMGS012		: org = 0x00C000, len = 0x006000		// CPU1 Program Memory RAMGS0 + RAMGS1 + RAMGS2 because of FLASH LOAD RUN copy structure
...
SECTIONS
{
   ...
   .text            : > RAMGS012, 	 PAGE = 0					// Executable Code and Constant.
