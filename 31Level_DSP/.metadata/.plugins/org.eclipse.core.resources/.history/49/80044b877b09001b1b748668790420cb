...
struct IPC_EtherCAT_Slave_Fault_BITS {
    Uint16                      Fault_RS485:8;
    Uint16                      Fault_SM_Vol:8;
    Uint16                      Fault_SM_Temp:16;
};
...
struct IPC_EtherCAT_Master_Operation_BITS {
    Uint16              Arm_current_Dir:8;              //Positive, Negative
...
extern struct IPC_EtherCAT_Master_DATA  Dsp1EcatMaster;
#endif
#ifdef CPU2
extern volatile struct IPC_EtherCAT_Master_DATA  IpcDspEcatMaster;
