...
#define CAN_CTL_IE1_INT1En                              0x00020000                  //
#define CAN_CTL_IE1_INT1Dis                             0x00000000                  //

#define CAN_CTL_SWR_SWReset                             0x00008000                  //

#define CAN_CTL_PMD_ParityOff                           0x00001400                  //
#define CAN_CTL_PMD_ParityOn                            0x00000000                  //

#define CAN_CTL_ABO_AutoBusOnEn                         0x00000200                  //
#define CAN_CTL_ABO_AutoBusOnDis                        0x00000000                  //

#define CAN_CTL_IDS_SoftEnterDebugMode                  0x00000100                  //
#define CAN_CTL_IDS_ImmediatlyEnterDebugMode            0x00000000                  //

#define CAN_CTL_TEST_TestMode                           0x00000080                  //
#define CAN_CTL_TEST_NormalMode                         0x00000000                  //

#define CAN_CTL_CCE_ConfigUnlock                        0x00000040                  //
#define CAN_CTL_CCE_ConfigLock                          0x00000000                  //

#define CAN_CTL_DAR_AutoReTXDis                         0x00000020                  //
#define CAN_CTL_DAR_AutoReTXEn                          0x00000000                  //

#define CAN_CTL_EIE_ErrorIntEn                          0x00000008                  //
#define CAN_CTL_EIE_ErrorIntDis                         0x00000000                  //

#define CAN_CTL_SIE_StatusChangeINT0En                  0x00000004                  //
#define CAN_CTL_SIE_StatusChangeINT0Dis                 0x00000000                  //

#define CAN_CTL_IE0_INT0En                              0x00000002                  //
#define CAN_CTL_IE0_INT0Dis                             0x00000000                  //

#define CAN_CTL_INIT_InitMode                           0x00000001                  //
#define CAN_CTL_INIT_NormalMode                         0x00000000                  //
...
//#define CAN_BTR_BRPE
#define CAN_BTR_BRPE_Value(val)                         (((Uint32)val & 0x0000000F) << 16)  //
#define CAN_BTR_TSEG2_Value(val)                        (((Uint32)val & 0x00000007) << 12)  //
#define CAN_BTR_TSEG1_Value(val)                        (((Uint32)val & 0x0000000F) << 8)   //
#define CAN_BTR_SJW_Value(val)                          (((Uint32)val & 0x00000003) << 6)   //
#define CAN_BTR_BRP_Value(val)                           ((Uint32)val & 0x0000003F)         //
...
#define CAN_TEST_RDA_RAMDirectTestMode                  0x00000200                  //
#define CAN_TEST_RDA_NormalMode                         0x00000000                  //

#define CAN_TEST_EXL_ExternalLoopTestMode               0x00000100                  //
#define CAN_TEST_EXL_NormalMode                         0x00000000                  //

#define CAN_TEST_TX_NormalMode                          0x00000000                  //

#define CAN_TEST_LBACK_LoopBackMode                     0x00000010                  //
#define CAN_TEST_LBACK_NormalMode                       0x00000000                  //

#define CAN_TEST_SILENT_RXOnlyMode                      0x00000008                  //
#define CAN_TEST_SILENT_NormalMode                      0x00000000                  //
...
#define CAN_IFxCMD_DIR_Write                            0x00800000                  //
#define CAN_IFxCMD_DIR_Read                             0x00000000                  //

#define CAN_IFxCMD_MASK_RW_MASKRegUpdate                0x00400000                  //
#define CAN_IFxCMD_MASK_RW_MASKRegRemain                0x00000000                  //

#define CAN_IFxCMD_ARB_RW_ARBRegUpdate                  0x00200000                  //
#define CAN_IFxCMD_ARB_RW_ARBRegRemain                  0x00000000                  //

#define CAN_IFxCMD_CONTROL_RW_MCTLRegUpdate             0x00100000                  //
#define CAN_IFxCMD_CONTROL_RW_MCTLRegRemain             0x00000000                  //

#define CAN_IFxCMD_CLRINTPND_R_INTPNDBitClear           0x00080000                  //

#define CAN_IFxCMD_TXRQST_R_NEWDATABitClear             0x00040000                  //
#define CAN_IFxCMD_TXRQST_W_TXRQSTnNEWDATBitByCONTROL   0x00000000                  //
#define CAN_IFxCMD_TXRQST_W_TXRQSTnNEWDATBitSet         0x00040000                  //

#define CAN_IFxCMD_DATA_RW_DATARegUpdate                0x00020000                  //
#define CAN_IFxCMD_DATA_RW_DATARegRemain                0x00000000                  //

#define CAN_IFxCMD_DATB_RW_DATBRegUpdate                0x00010000                  //
#define CAN_IFxCMD_DATB_RW_DATBRegRemain                0x00000000                  //

#define CAN_IFxCMD_BUSY_BUSYFlag                        0x00008000                  //

#define CAN_IFxCMD_MSG_NUM(val)                         ((Uint32)val & 0x000000FF)  //
...
#define CAN_IFxMSK_MXTD_IDENonMasked                    0x80000000                  //
#define CAN_IFxMSK_MXTD_IDEMasked                       0x00000000                  //

#define CAN_IFxMSK_MDIR_DIRNonMasked                    0x40000000                  //
#define CAN_IFxMSK_MDIR_DIRMasked                       0x00000000                  //

#define CAN_IFxMSK_MSK_Standard_11BitMasked             0x0FFFFFFF                  //
#define CAN_IFxMSK_MSK_Standard_10BitMasked             0x17FFFFFF                  //
#define CAN_IFxMSK_MSK_Standard_9BitMasked              0x1BFFFFFF                  //
#define CAN_IFxMSK_MSK_Standard_8BitMasked              0x1DFFFFFF                  //
#define CAN_IFxMSK_MSK_Standard_7BitMasked              0x1EFFFFFF                  //
#define CAN_IFxMSK_MSK_Standard_6BitMasked              0x1F7FFFFF                  //
#define CAN_IFxMSK_MSK_Standard_5BitMasked              0x1FBFFFFF                  //
#define CAN_IFxMSK_MSK_Standard_4BitMasked              0x1FDFFFFF                  //
#define CAN_IFxMSK_MSK_Standard_3BitMasked              0x1FEFFFFF                  //
#define CAN_IFxMSK_MSK_Standard_2BitMasked              0x1FF7FFFF                  //
#define CAN_IFxMSK_MSK_Standard_1BitMasked              0x1FFBFFFF                  //

#define CAN_IFxMSK_MSK_Extended_29BitMasked             0x0FFFFFFF                  //
#define CAN_IFxMSK_MSK_Extended_28BitMasked             0x17FFFFFF                  //
#define CAN_IFxMSK_MSK_Extended_27BitMasked             0x1BFFFFFF                  //
#define CAN_IFxMSK_MSK_Extended_26BitMasked             0x1DFFFFFF                  //
#define CAN_IFxMSK_MSK_Extended_25BitMasked             0x1EFFFFFF                  //
#define CAN_IFxMSK_MSK_Extended_24BitMasked             0x1F7FFFFF                  //
#define CAN_IFxMSK_MSK_Extended_23BitMasked             0x1FBFFFFF                  //
#define CAN_IFxMSK_MSK_Extended_22BitMasked             0x1FDFFFFF                  //
#define CAN_IFxMSK_MSK_Extended_21BitMasked             0x1FEFFFFF                  //
#define CAN_IFxMSK_MSK_Extended_20BitMasked             0x1FF7FFFF                  //
#define CAN_IFxMSK_MSK_Extended_19BitMasked             0x1FFBFFFF                  //
#define CAN_IFxMSK_MSK_Extended_18BitMasked             0x1FFDFFFF                  //
#define CAN_IFxMSK_MSK_Extended_17BitMasked             0x1FFEFFFF                  //
#define CAN_IFxMSK_MSK_Extended_16BitMasked             0x1FFF7FFF                  //
#define CAN_IFxMSK_MSK_Extended_15BitMasked             0x1FFFBFFF                  //
#define CAN_IFxMSK_MSK_Extended_14BitMasked             0x1FFFDFFF                  //
#define CAN_IFxMSK_MSK_Extended_13BitMasked             0x1FFFEFFF                  //
#define CAN_IFxMSK_MSK_Extended_12BitMasked             0x1FFFF7FF                  //
#define CAN_IFxMSK_MSK_Extended_11BitMasked             0x1FFFFBFF                  //
#define CAN_IFxMSK_MSK_Extended_10BitMasked             0x1FFFFDFF                  //
#define CAN_IFxMSK_MSK_Extended_9BitMasked              0x1FFFFEFF                  //
#define CAN_IFxMSK_MSK_Extended_8BitMasked              0x1FFFFF7F                  //
#define CAN_IFxMSK_MSK_Extended_7BitMasked              0x1FFFFFBF                  //
#define CAN_IFxMSK_MSK_Extended_6BitMasked              0x1FFFFFDF                  //
#define CAN_IFxMSK_MSK_Extended_5BitMasked              0x1FFFFFEF                  //
#define CAN_IFxMSK_MSK_Extended_4BitMasked              0x1FFFFFF7                  //
#define CAN_IFxMSK_MSK_Extended_3BitMasked              0x1FFFFFFB                  //
#define CAN_IFxMSK_MSK_Extended_2BitMasked              0x1FFFFFFD                  //
#define CAN_IFxMSK_MSK_Extended_1BitMasked              0x1FFFFFFE                  //

//// CAN_IFxMSK Register : Quick Value
#define CAN_IFxMSK_MSK_AllNonMasked                     0x1FFFFFFF                  //
#define CAN_IFxMSK_MSK_AllMasked                        0x00000000                  //
...
#define CAN_IFxARB_MSGVAL_MSGBoxEn                      0x80000000                  //
#define CAN_IFxARB_MSGVAL_MSGBoxDis                     0x00000000                  //

#define CAN_IFxARB_XTD_Extended                         0x40000000                  //
#define CAN_IFxARB_XTD_Standard                         0x00000000                  //

#define CAN_IFxARB_DIR_TX_DataFrame                     0x20000000                  //
#define CAN_IFxARB_DIR_TX_RemoteFrame                   0x00000000                  //
#define CAN_IFxARB_DIR_RX_RemoteFrame                   0x20000000                  //
#define CAN_IFxARB_DIR_RX_DataFrame                     0x00000000                  //

#define CAN_IFxARB_StandardID(val)                      (((Uint32)val & 0x000007FF) << 18)  //
#define CAN_IFxARB_ExtendedID(val)                       ((Uint32)val & 0x1FFFFFFF)         //
...
#define CAN_IFxMCTL_NEWDATA_NewData                     0x00008000                  //
#define CAN_IFxMCTL_NEWDATA_TransceivedData             0x00000000                  //

#define CAN_IFxMCTL_MSGLST_R_DataOverWriten             0x00004000                  //

#define CAN_IFxMCTL_INTPND_IntSource                    0x00002000                  //

#define CAN_IFxMCTL_UMASK_MSKRegUsed                    0x00001000                  //
#define CAN_IFxMCTL_UMASK_MSKRegIgnore                  0x00000000                  //

#define CAN_IFxMCTL_TXIE_TXCompleteIntEn                0x00000800                  //
#define CAN_IFxMCTL_TXIE_TXCompleteIntDis               0x00000000                  //

#define CAN_IFxMCTL_RXIE_RXCompleteIntEn                0x00000400                  //
#define CAN_IFxMCTL_RXIE_RXCompleteIntDis               0x00000000                  //

#define CAN_IFxMCTL_RMTEN_RemoteEn                      0x00000200                  //
#define CAN_IFxMCTL_RMTEN_RemoteDis                     0x00000000                  //

#define CAN_IFxMCTL_TXRQST_TXRequest                    0x00000100                  //

#define CAN_IFxMCTL_EOB_LastMSGinFIFO                   0x00000080                  //

#define CAN_IFxMCTL_DLC_DataLength(val)                 ((Uint32)val & 0x0000000F)          //
