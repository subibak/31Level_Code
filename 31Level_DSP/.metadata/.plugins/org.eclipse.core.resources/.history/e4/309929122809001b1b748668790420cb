...
void Init_GPIO(void)
{
	...
	//GPIO B Analog Mode Select				; 0(digital funtion), 1(analog function)
	...
	GpioCtrlRegs.GPBCSEL3.bit.GPIO48 = 0;
	GpioCtrlRegs.GPBCSEL3.bit.GPIO49 = 0;
	GpioCtrlRegs.GPBCSEL3.bit.GPIO50 = 0;
	GpioCtrlRegs.GPBCSEL3.bit.GPIO51 = 0;
	...
	GpioCtrlRegs.GPECSEL2.bit.GPIO138 = 0;
	GpioCtrlRegs.GPECSEL2.bit.GPIO139 = 0;
