...
void PD(int NUM_SM, int Cur_dir, int Vxn_ref_NLC, Uint16 Vxn_ref_PWM, int SM_INDEX[], Uint16 SM_REF[])
{
    PWM_x = (Vxn_ref_PWM > MAX_CNT_CARRIER)? MAX_CNT_CARRIER : Vxn_ref_PWM;
    NLC_x = (Uint16)((Vxn_ref_NLC > NUM_SM)? NUM_SM : ((Vxn_ref_NLC < 0) ? 0 : Vxn_ref_NLC));
...
void NLC(int NUM_SM, int Cur_dir, int Vxn_ref_NLC, int SM_INDEX[], Uint16 SM_REF[])
{
    NLC_x = (Uint16)((Vxn_ref_NLC >= NUM_SM)? NUM_SM : ((Vxn_ref_NLC < 0) ? 0 : Vxn_ref_NLC));
