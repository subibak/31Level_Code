...
void GPMC_Central_Leg(void)
{
    ...
    CenLegOpData_Aupper.bit.Flag_Operation = 1;//Flag_gating;
    CenLegOpData_Alower.bit.Flag_Operation = 1;//Flag_gating;
    CenLegOpData_Bupper.bit.Flag_Operation = 1;//Flag_gating;
    CenLegOpData_Blower.bit.Flag_Operation = 1;//Flag_gating;
    CenLegOpData_Cupper.bit.Flag_Operation = 1;//Flag_gating;
    CenLegOpData_Clower.bit.Flag_Operation = 1;//Flag_gating;
...
//    SmSumCL[4].bit.MSB = SM_SUM_GROUP_CL5_MSB;
    ...
    SmFaultA.bit.COM_VOL.all =  SM_FAULT_A_COM;
    SmFaultA.bit.TEMPERATURE =  SM_FAULT_A_VOL;
    SmFaultA.bit.COM_VOL.all =  SM_FAULT_A_TEM;

    SmFaultB.bit.COM_VOL.all =  SM_FAULT_B_COM;
    SmFaultB.bit.TEMPERATURE =  SM_FAULT_B_VOL;
