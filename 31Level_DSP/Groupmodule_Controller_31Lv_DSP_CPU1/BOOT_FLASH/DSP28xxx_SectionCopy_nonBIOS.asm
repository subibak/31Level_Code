...
; Revised Date: 2018.09.22
; Revisor 	  : subi
;############################################################################

	.ref _c_int00
	.global copy_sections
	.global _ramfunc_loadstart, _ramfunc_runstart, _ramfunc_size
...
copy_sections:
	...
	MOVL XAR5,#_ramfunc_size			; Store Section Size in XAR5
	MOVL ACC,@XAR5						; Move Section Size to ACC
	MOVL XAR6,#_ramfunc_loadstart		; Store Load Starting Address in XAR6
    MOVL XAR7,#_ramfunc_runstart		; Store Run Address in XAR7
