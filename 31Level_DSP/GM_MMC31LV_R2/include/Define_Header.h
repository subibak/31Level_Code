...
#include "Define_Dual_core.h"
#include "Define_EMIF.h"
#include "Define_ePWM.h"
#include "Define_FPGA_GPIO.h"
#include "Define_input_xbar.h"
...
#define TIMEBASE1_PERIOD				40000		            //  1000  / 1250   /  2000  /  5000  /  10000		// Switching & Current Control (SYSCLKOUT(200[MHz]) / 2 / 20000 = 5[kHZ])
#define TIMEBASE1_PERIOD_HALF			20000		            //   500  /  625	/  1000  /  2500  /  5000
...
#define OUTERLOOP_SAMPLING_TIME			2e-3F		            //  0.1e-3F  / 0.125e-3F / 0.2e-3F / 0.5e-3F / 1e-3F
#define INV_OUTERLOOP_SAMPLING_TIME		5e2F 		            //    10e3F  / 8e3F    /   5e3F  /   2e3F  / 1e3F
...
#define EtherCAT1_ON                    GpioDataRegs.GPESET.bit.GPIO154 = 1
#define EtherCAT1_OFF                   GpioDataRegs.GPECLEAR.bit.GPIO154 = 1
#define EtherCAT2_ON                    GpioDataRegs.GPESET.bit.GPIO153 = 1
#define EtherCAT2_OFF                   GpioDataRegs.GPECLEAR.bit.GPIO153 = 1
