...
void Init_GPIO(void)
{
	...
	GpioCtrlRegs.GPAGMUX2.bit.GPIO28 = 0;	// [n,0](GPIO28),			[0,1](SCIRXDA[I]),			[0,2](EM1CS4n[O]),			[0,3](Reserved)			;EM1CS4n
	GpioCtrlRegs.GPAMUX2.bit.GPIO28 = 2;	// [1,1](OUTPUTXBAR5[O]),	[1,2](EQEP3A[I]),			[1,3](SD2_D3[I]),			[3,3](Reserved)
	...
	GpioCtrlRegs.GPEMUX1.bit.GPIO134 = 0;	// [1,1](Reserved),			[1,2](Reserved),			[1,3](SD2_D3[I]),			[3,3](Reserved)			;XF2
	...
	GpioCtrlRegs.GPEMUX1.bit.GPIO137 = 0;	// [1,1](Reserved),			[1,2](SCITXDB[O]),			[1,3](SD2_C4[I]),			[3,3](Reserved)

	GpioCtrlRegs.GPEGMUX1.bit.GPIO138 = 0;	// [n,0](GPIO138),			[0,1](Reserved),			[0,2](Reserved),			[0,3](Reserved)
	GpioCtrlRegs.GPEMUX1.bit.GPIO138 = 0;	// [1,1](Reserved),			[1,2](SCIRXDB[I]),			[1,3](Reserved),			[3,3](Reserved)			;GPIO138(LED3, D5)

	GpioCtrlRegs.GPEGMUX1.bit.GPIO139 = 0;	// [n,0](GPIO139),			[0,1](Reserved),			[0,2](Reserved),			[0,3](Reserved)
	GpioCtrlRegs.GPEMUX1.bit.GPIO139 = 0;	// [1,1](Reserved),			[1,2](SCIRXDC[I]),			[1,3](Reserved),			[3,3](Reserved)			;GPIO139(LED2, D3)

	GpioCtrlRegs.GPEGMUX1.bit.GPIO140 = 0;	// [n,0](GPIO140),			[0,1](Reserved),			[0,2](Reserved),			[0,3](Reserved)
	GpioCtrlRegs.GPEMUX1.bit.GPIO140 = 0;	// [1,1](Reserved),			[1,2](SCITXDC[O]),			[1,3](Reserved),			[3,3](Reserved)			;GPIO140(LED1, D2)

	GpioCtrlRegs.GPEGMUX1.bit.GPIO141 = 0;	// [n,0](GPIO141),			[0,1](Reserved),			[0,2](Reserved),			[0,3](Reserved)
	GpioCtrlRegs.GPEMUX1.bit.GPIO141 = 0;	// [1,1](Reserved),			[1,2](SCIRXDD[I]),			[1,3](Reserved),			[3,3](Reserved)			;GPIO141(LED0, D1)
	...
	GpioCtrlRegs.GPEMUX2.bit.GPIO144 = 0;	// [1,1](Reserved),			[1,2](Reserved),			[1,3](Reserved),			[3,3](Reserved)			;XF1

	GpioCtrlRegs.GPEGMUX2.bit.GPIO145 = 0;	// [n,0](GPIO145),			[0,1](EPWM1A[O]),			[0,2](Reserved),			[0,3](Reserved)
	GpioCtrlRegs.GPEMUX2.bit.GPIO145 = 0;	// [1,1](Reserved),			[1,2](Reserved),			[1,3](Reserved),			[3,3](Reserved)			;

	GpioCtrlRegs.GPEGMUX2.bit.GPIO146 = 0;	// [n,0](GPIO146),			[0,1](EPWM1B[O]),			[0,2](Reserved),			[0,3](Reserved)
	GpioCtrlRegs.GPEMUX2.bit.GPIO146 = 0;	// [1,1](Reserved),			[1,2](Reserved),			[1,3](Reserved),			[3,3](Reserved)			;

	GpioCtrlRegs.GPEGMUX2.bit.GPIO147 = 0;	// [n,0](GPIO147),			[0,1](EPWM2A[O]),			[0,2](Reserved),			[0,3](Reserved)
	GpioCtrlRegs.GPEMUX2.bit.GPIO147 = 0;	// [1,1](Reserved),			[1,2](Reserved),			[1,3](Reserved),			[3,3](Reserved)			;

	GpioCtrlRegs.GPEGMUX2.bit.GPIO148 = 0;	// [n,0](GPIO148),			[0,1](EPWM2B[O]),			[0,2](Reserved),			[0,3](Reserved)
	GpioCtrlRegs.GPEMUX2.bit.GPIO148 = 0;	// [1,1](Reserved),			[1,2](Reserved),			[1,3](Reserved),			[3,3](Reserved)			;

	GpioCtrlRegs.GPEGMUX2.bit.GPIO149 = 0;	// [n,0](GPIO149),			[0,1](EPWM3A[O]),			[0,2](Reserved),			[0,3](Reserved)
	GpioCtrlRegs.GPEMUX2.bit.GPIO149 = 0;	// [1,1](Reserved),			[1,2](Reserved),			[1,3](Reserved),			[3,3](Reserved)			;

	GpioCtrlRegs.GPEGMUX2.bit.GPIO150 = 0;	// [n,0](GPIO150),			[0,1](EPWM3B[O]),			[0,2](Reserved),			[0,3](Reserved)
	GpioCtrlRegs.GPEMUX2.bit.GPIO150 = 0;	// [1,1](Reserved),			[1,2](Reserved),			[1,3](Reserved),			[3,3](Reserved)			;

	GpioCtrlRegs.GPEGMUX2.bit.GPIO151 = 0;	// [n,0](GPIO151),			[0,1](EPWM4A[O]),			[0,2](Reserved),			[0,3](Reserved)
	GpioCtrlRegs.GPEMUX2.bit.GPIO151 = 0;	// [1,1](Reserved),			[1,2](Reserved),			[1,3](Reserved),			[3,3](Reserved)			;

	GpioCtrlRegs.GPEGMUX2.bit.GPIO152 = 0;	// [n,0](GPIO152),			[0,1](EPWM4B[O]),			[0,2](Reserved),			[0,3](Reserved)
	GpioCtrlRegs.GPEMUX2.bit.GPIO152 = 0;	// [1,1](Reserved),			[1,2](Reserved),			[1,3](Reserved),			[3,3](Reserved)			;

	GpioCtrlRegs.GPEGMUX2.bit.GPIO153 = 0;	// [n,0](GPIO153),			[0,1](EPWM5A[O]),			[0,2](Reserved),			[0,3](Reserved)
	GpioCtrlRegs.GPEMUX2.bit.GPIO153 = 0;	// [1,1](Reserved),			[1,2](Reserved),			[1,3](Reserved),			[3,3](Reserved)			;

	GpioCtrlRegs.GPEGMUX2.bit.GPIO154 = 0;	// [n,0](GPIO154),			[0,1](EPWM5B[O]),			[0,2](Reserved),			[0,3](Reserved)
	GpioCtrlRegs.GPEMUX2.bit.GPIO154 = 0;	// [1,1](Reserved),			[1,2](Reserved),			[1,3](Reserved),			[3,3](Reserved)			;

	GpioCtrlRegs.GPEGMUX2.bit.GPIO155 = 0;	// [n,0](GPIO155),			[0,1](EPWM6A[O]),			[0,2](Reserved),			[0,3](Reserved)
	GpioCtrlRegs.GPEMUX2.bit.GPIO155 = 0;	// [1,1](Reserved),			[1,2](Reserved),			[1,3](Reserved),			[3,3](Reserved)			;

	GpioCtrlRegs.GPEGMUX2.bit.GPIO156 = 0;	// [n,0](GPIO156),			[0,1](EPWM6B[O]),			[0,2](Reserved),			[0,3](Reserved)
	GpioCtrlRegs.GPEMUX2.bit.GPIO156 = 0;	// [1,1](Reserved),			[1,2](Reserved),			[1,3](Reserved),			[3,3](Reserved)			;
