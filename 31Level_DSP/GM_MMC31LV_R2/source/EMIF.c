...
{   //EMIF1
    ...
    Emif1ConfigRegs.EMIF1MSEL.all = 0x93A5CE72;              // KEY value and Msel value must be written together at a time using 'all'
                                                             // KEY : 93A5CE7, MSEL_EMIF1 : 0x01 CPU1 is Master, 0x02 CPU2 is Master
    ...
    ClkCfgRegs.PERCLKDIVSEL.bit.EMIF1CLKDIV = 1;            // EMxCLK = PLLSYSCLK / 1, 0: 200 Mhz, 1: 100Mhz
    ...
    // Write cycle
    Emif1Regs.ASYNC_CS2_CR.bit.W_SETUP = 2;                 // Write Strobe Setup cycles
    Emif1Regs.ASYNC_CS2_CR.bit.W_STROBE = 3;                // Write Strobe Duration cycles
    Emif1Regs.ASYNC_CS2_CR.bit.W_HOLD = 2;                  // Write Strobe Hold cycles

    // Read cycle
    Emif1Regs.ASYNC_CS2_CR.bit.R_SETUP = 2;                 // Read Strobe Setup cycles
    Emif1Regs.ASYNC_CS2_CR.bit.R_STROBE = 3;                // Read Strobe Duration cycles
    Emif1Regs.ASYNC_CS2_CR.bit.R_HOLD = 2;                  // Read Strobe Hold cycles
    ...
    // Write cycle
    Emif1Regs.ASYNC_CS3_CR.bit.W_SETUP = 2;                 // Write Strobe Setup cycles
    Emif1Regs.ASYNC_CS3_CR.bit.W_STROBE = 3;                // Write Strobe Duration cycles
    Emif1Regs.ASYNC_CS3_CR.bit.W_HOLD = 2;                  // Write Strobe Hold cycles

    // Read cycle
    Emif1Regs.ASYNC_CS3_CR.bit.R_SETUP = 2;                 // Read Strobe Setup cycles
    Emif1Regs.ASYNC_CS3_CR.bit.R_STROBE = 3;                // Read Strobe Duration cycles
    Emif1Regs.ASYNC_CS3_CR.bit.R_HOLD = 2;                  // Read Strobe Hold cycles
    ...
    // Write cycle
    Emif1Regs.ASYNC_CS4_CR.bit.W_SETUP = 2;                 // Write Strobe Setup cycles
    Emif1Regs.ASYNC_CS4_CR.bit.W_STROBE = 3;                // Write Strobe Duration cycles
    Emif1Regs.ASYNC_CS4_CR.bit.W_HOLD = 2;                  // Write Strobe Hold cycles

    // Read cycle
    Emif1Regs.ASYNC_CS4_CR.bit.R_SETUP = 2;                 // Read Strobe Setup cycles
    Emif1Regs.ASYNC_CS4_CR.bit.R_STROBE = 3;                // Read Strobe Duration cycles
    Emif1Regs.ASYNC_CS4_CR.bit.R_HOLD = 2;                  // Read Strobe Hold cycles
#endif
    return;
}
