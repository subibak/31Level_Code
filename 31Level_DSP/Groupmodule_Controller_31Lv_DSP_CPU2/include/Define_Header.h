...
#include "Define.Fault.h"
#include "Define_DAC.h"
#include "Define_ePWM.h"
#include "Define_xint.h"
...
#define TIMEBASE1_PERIOD				20000		//  1000  / 1250   /  2000  /  5000  /  10000		// Switching & Current Control (SYSCLKOUT(200[MHz]) / 2 / 10000 = 10[kHZ])
#define TIMEBASE1_PERIOD_HALF			10000		//   500  /  625	/  1000  /  2500  /  5000
#define TIMEBASE2_PERIOD_HALF			10000
...
#define MAX_NUM_SM                      6
#define MAX_CNT_CARRIER               10000
#define DAQ_RS422_MAX                 10000
