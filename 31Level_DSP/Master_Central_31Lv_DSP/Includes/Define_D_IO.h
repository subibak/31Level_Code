...
#define PRE_MC_OFF     GPIO3Regs.GPIO_SETDATAOUT.all     = GPIO_GPIO4               // PRE_MC_OFF
#define PRE_MC_ON      GPIO3Regs.GPIO_CLEARDATAOUT.all   = GPIO_GPIO4               // PRE_MC_ON
#define MAIN_MC_OFF    GPIO3Regs.GPIO_SETDATAOUT.all     = GPIO_GPIO5               // MAIN_MC_OFF
#define MAIN_MC_ON     GPIO3Regs.GPIO_CLEARDATAOUT.all   = GPIO_GPIO5               // MAIN_MC_ON
