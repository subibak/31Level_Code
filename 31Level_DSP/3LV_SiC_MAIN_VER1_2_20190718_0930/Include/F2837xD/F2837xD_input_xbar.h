...
//
// TITLE:   F2837xD Device INPUT_XBAR Register Definitions.
//
//###########################################################################
...
//// INPUTSELECTLOCK Register : Byte Value
#define INPUTSELECTLOCK_INPUT1SELECT_Lock				0x00000001UL				//
#define INPUTSELECTLOCK_INPUT2SELECT_Lock				0x00000002UL				//
#define INPUTSELECTLOCK_INPUT3SELECT_Lock				0x00000004UL				//
#define INPUTSELECTLOCK_INPUT4SELECT_Lock				0x00000008UL				//
#define INPUTSELECTLOCK_INPUT5SELECT_Lock				0x00000010UL				//
#define INPUTSELECTLOCK_INPUT6SELECT_Lock				0x00000020UL				//
#define INPUTSELECTLOCK_INPUT7SELECT_Lock				0x00000040UL				//
#define INPUTSELECTLOCK_INPUT8SELECT_Lock				0x00000080UL				//
#define INPUTSELECTLOCK_INPUT9SELECT_Lock				0x00000100UL				//
#define INPUTSELECTLOCK_INPUT10SELECT_Lock				0x00000200UL				//
#define INPUTSELECTLOCK_INPUT11SELECT_Lock				0x00000400UL				//
#define INPUTSELECTLOCK_INPUT12SELECT_Lock				0x00000800UL				//
#define INPUTSELECTLOCK_INPUT13SELECT_Lock				0x00001000UL				//
#define INPUTSELECTLOCK_INPUT14SELECT_Lock				0x00002000UL				//
