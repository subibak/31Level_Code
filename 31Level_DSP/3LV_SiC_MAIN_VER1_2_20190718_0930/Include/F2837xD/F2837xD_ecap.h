...
// FILE:    F2837xD_ecap.h
//
// TITLE:   F2837xD Device ECAP Register Definitions.
//
//###########################################################################
...
// ECCTL1 Register
//// ECCTL1 Register : Byte Value
#define ECCTL1_FREE_SOFT_FreeRun					0x8000						//
#define ECCTL1_FREE_SOFT_SoftStop					0x4000						//
#define ECCTL1_FREE_SOFT_Immediately				0x0000						//

#define ECCTL1_PRESCALE_Val(val)					(val & 0x001F) << 9			//

#define ECCTL1_CAPLDEN_CaptureEnable				0x0100						//
#define ECCTL1_CAPLDEN_CaptureDisable				0x0000						//

#define ECCTL1_CTRRST4_DeltaTimeMode				0x0080						//
#define ECCTL1_CTRRST4_ABSTimeMode					0x0000						//

#define ECCTL1_CAP4POL_FallingEdge					0x0040						//
#define ECCTL1_CAP4POL_RisingEdge					0x0000						//

#define ECCTL1_CTRRST3_DeltaTimeMode				0x0020						//
#define ECCTL1_CTRRST3_ABSTimeMode					0x0000						//

#define ECCTL1_CAP3POL_FallingEdge					0x0010						//
#define ECCTL1_CAP3POL_RisingEdge					0x0000						//

#define ECCTL1_CTRRST2_DeltaTimeMode				0x0008						//
#define ECCTL1_CTRRST2_ABSTimeMode					0x0000						//

#define ECCTL1_CAP2POL_FallingEdge					0x0004						//
#define ECCTL1_CAP2POL_RisingEdge					0x0000						//

#define ECCTL1_CTRRST1_DeltaTimeMode				0x0002						//
#define ECCTL1_CTRRST1_ABSTimeMode					0x0000						//

#define ECCTL1_CAP1POL_FallingEdge					0x0001						//
#define ECCTL1_CAP1POL_RisingEdge					0x0000						//
...
// ECCTL2 Register
//// ECCTL2 Register : Byte Value
#define ECCTL2_APWMPOL_APWMACTVLow					0x0400						//
#define ECCTL2_APWMPOL_APWMACTVHigh					0x0000						//

#define ECCTL2_CAP_APWM_APWMMode					0x0200						//
#define ECCTL2_CAP_APWM_CaptureMode					0x0000						//

#define ECCTL2_SYNCO_SEL_Disable					0x0080						//
#define ECCTL2_SYNCO_SEL_Period						0x0040						//
#define ECCTL2_SYNCO_SEL_SYNCIN						0x0000						//

#define ECCTL2_SYNCI_EN_SYNCEnable					0x0020						//
#define ECCTL2_SYNCI_EN_SYNCDisable					0x0000						//

#define ECCTL2_TSCTRSTOP_TSCTRRun					0x0010						//
#define ECCTL2_TSCTRSTOP_TSCTRFreeze				0x0000						//

#define ECCTL2_STOP_WARP_CAP1to4En					0x0006						//
#define ECCTL2_STOP_WARP_CAP1to3En					0x0004						//
#define ECCTL2_STOP_WARP_CAP1to2En					0x0002						//
#define ECCTL2_STOP_WARP_CAP1En						0x0000						//

#define ECCTL2_CONT_ONESHT_ONESHTMode				0x0001						//
#define ECCTL2_CONT_ONESHT_CONTMode					0x0000						//
